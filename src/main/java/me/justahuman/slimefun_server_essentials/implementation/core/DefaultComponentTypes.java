...
public class DefaultComponentTypes {
    ...
    public static final ComponentType ENERGY = new FillingComponentType(
            ...
            new ConditionalRenderable(
                    new SimpleRenderable(SimpleRenderable.WIDGETS, 7, 9, 43, 0, "%abs_total_energy%J Generated"),
                    new SimpleRenderable(SimpleRenderable.WIDGETS, 7, 9, 50, 0, "%abs_total_energy%J Consumed"),
            ...
            new ConditionalRenderable(
                    new SimpleRenderable(SimpleRenderable.WIDGETS_DARK, 7, 9, 43, 0, "%abs_total_energy%J Generated"),
                    new SimpleRenderable(SimpleRenderable.WIDGETS_DARK, 7, 9, 50, 0, "%abs_total_energy%J Consumed"),
                    new Condition(Condition.PROPERTY_ENERGY, Condition.CONDITION_GREATER_EQUALS, 0)
            ).optional(Condition.HAS_ENERGY),
            7, 9, 500, false
    ).register();
    ...
    public static final ComponentType FILLING_ARROW_RIGHT = new FillingComponentType(
            "filling_arrow_right",
            ARROW_RIGHT.light(),
            new SimpleRenderable(SimpleRenderable.WIDGETS, 24, 17, 44, 239, "%time_seconds% Seconds (%time_ticks% Ticks)").optional(Condition.HAS_TICKS),
            ARROW_RIGHT.dark(),
            new SimpleRenderable(SimpleRenderable.WIDGETS_DARK, 24, 17, 44, 239, "%time_seconds% Seconds (%time_ticks% Ticks)").optional(Condition.HAS_TICKS),
    ...
    public static final ComponentType FILLING_ARROW_LEFT = new FillingComponentType(
            "filling_arrow_left",
            ARROW_LEFT.light(),
            new SimpleRenderable(SimpleRenderable.WIDGETS, 24, 17, 67, 239, "%time_seconds% Seconds (%time_ticks% Ticks)").optional(Condition.HAS_TICKS),
            ARROW_LEFT.dark(),
            new SimpleRenderable(SimpleRenderable.WIDGETS_DARK, 24, 17, 67, 239, "%time_seconds% Seconds (%time_ticks% Ticks)").optional(Condition.HAS_TICKS),
            24, 17, FillingComponentType.RECIPE_TIME,
